...
public class IfStmt extends Statement
  {
    ...
    private List<Statement> thenStmts; // List of Statement objects following
                                       // "then"
    private List<ElsifPart> elsifParts; // List of ElsifPart objects
    private List<Statement> elseStmts; // List of Statement objects following
                                       // "else"
     ...
     *
     * @param booleanExpr
     *          the boolean expression that, if true, will result in the
     *          execution of the list of "then" statements.
     * @param thenStmts
     *          the statements to be executed when the boolean expression
     *          evaluates to true.
     */
    ...
    /**
     * Add a list of "else" statements to this if statement. These are the
     * statements that get executed if boolean expressions associated with the
     * if statement and all elsif parts evaluate to false.
     *
     * @param elseStmts
     *          the list of else statements for this if statement.
     */
    ...
    public void emit() throws CodeGenException, IOException
      {
        ...
        // if there are elsif parts or an else part, branch to end of if
        // statement
