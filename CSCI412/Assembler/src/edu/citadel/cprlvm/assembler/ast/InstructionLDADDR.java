 ...
 * the assembly language instruction LDADDR.
 */
public class InstructionLDADDR extends InstructionOneArg
  {
    public InstructionLDADDR(List<Token> labels, Token opCode, Token arg)
      {
