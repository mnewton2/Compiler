 ...
 * the assembly language instruction LDMEM.
 */
public class InstructionLDMEM extends InstructionOneArg
  {
    public InstructionLDMEM(List<Token> labels, Token opCode, Token arg)
      {
