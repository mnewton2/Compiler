...
public class Variable extends Expression
  {
    NamedDecl decl;
    List<Expression> indexExprs;   // index expressions for an array;
    ...
    public void checkConstraints()
      {
        try
          {
            InternalAssertion.check(decl instanceof SingleVarDecl || decl instanceof ParameterDecl,
            ...
            for (Expression expr : indexExprs)
               {
                 ...
                 if (expr.getType() != Type.Integer)
                   {
                     Position errorPosition = expr.getPosition();
                     String   errorMessage  = "Index expression must have type Integer.";
                ...
                if (getType() instanceof ArrayType)
                  ...
                  {
                    Position errorPosition = expr.getPosition();
                    String   errorMessage  = "Index expression not allowed; not an array";
