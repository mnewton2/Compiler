    ...
    public LogicalExpr(Expression leftOperand, Token operator, Expression rightOperand)
      {
        ...
        InternalAssertion.check(SymbolUtil.isLogicalOperator(operator.getSymbol()),
            ...
            if (leftOperand.getType() != Type.Boolean)
              {
                ...
                String   errorMessage  = "Left operand for a logical expression "
            ...
            if (rightOperand.getType() != Type.Boolean)
              {
                ...
                String   errorMessage  = "Right operand for a logical expression "
                                       + "should have type Boolean.";
